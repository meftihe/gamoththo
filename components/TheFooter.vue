<template>
  <footer class="absolute bottom-0 w-full bg-white rounded-lg shadow sm:flex sm:items-center sm:justify-between p-4 sm:p-6 xl:p-8 dark:bg-gray-800 antialiased">
    <p class="mb-4 text-sm text-center text-gray-500 dark:text-gray-400 sm:mb-0">
        &copy; 2019-2022 <NuxtLink to="https://wuletawwonte.com/" class="hover:underline" target="_blank">wuletawwonte.com</NuxtLink>. All rights reserved.
    </p>
